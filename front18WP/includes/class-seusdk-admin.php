            ...
            <form method="post" action="options.php">
                ...
                <div class="front18-card">
                    ...
                    <div class="front18-row" style="flex-direction: column; align-items: stretch; gap: 10px;">
                        ...
                        <input type="password" name="front18_api_key" value="<?php echo esc_attr( $api_key ); ?>" class="front18-input" placeholder="<?php esc_attr_e( 'Cole sua chave aqui...', 'front18' ); ?>" autocomplete="off" />
                    </div>
                </div>
