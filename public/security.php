...
<head>
    ...
    <title>Tecnologia e Privacidade - Front18</title>
...
<body class="tech-grid min-h-screen flex flex-col pt-12 md:pt-20">
    ...
    <div class="max-w-3xl mx-auto px-6 pb-24 relative z-10 w-full">
        ...
        <!-- Header -->
        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight mb-6">Como a <span class="gradient-text">Tecnologia</span> Front18 Mitiga Riscos</h1>
        ...
        <div class="space-y-6">
            ...
            <div class="glass-card rounded-2xl p-8 transition-all hover:border-slate-700">
                ...
                <p class="text-slate-400 leading-relaxed">A tecnologia biométrica corporativa atua no campo da previsibilidade. A solução <b>Front18 atua como um previsor estatístico</b> (Proxy Prediction), afastando robôs e acessos infantis óbvios. <strong>Nosso algoritmo não oferece uma garantia irrefutável sobre a idade civil (como faz um documento do governo)</strong>, mas estabelece uma sólida parede de "boa-fé jurídica". Essa rastreabilidade técnica diminui esmagadoramente a responsabilidade corporativa do lojista na Justiça.</p>
            </div>
            ...
            <div class="glass-card rounded-2xl p-8 transition-all hover:border-slate-700">
                ...
                <div class="mt-4 bg-slate-900/50 p-4 border border-slate-800 rounded-lg">
                    <ul class="space-y-3 text-sm text-slate-300">
                        ...
                        <li class="flex items-start gap-3"><svg class="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> <span><b>Métricas Anônimas:</b> Apenas os <i>inteiros processados</i> (Idade e Precisão Geográfica) são enviados ao cofre do Front18, sem vinculação ao CPF.</span></li>
